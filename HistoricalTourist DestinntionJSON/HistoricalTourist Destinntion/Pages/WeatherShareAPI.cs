...
namespace WeatherShare
{
    ...
    public partial class WeatherShareApi
    {
    ...
    public partial class WeatherShareApi
    {
        public static WeatherShareApi FromJson(string json)
        {
            return JsonConvert.DeserializeObject<WeatherShareApi>(json, WeatherShare.Converter.Settings);
        }
    }

    public static class Serialize
    {
        public static string ToJson(this WeatherShareApi self)
        {
            return JsonConvert.SerializeObject(self, WeatherShare.Converter.Settings);
        }
    }
